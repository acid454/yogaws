...
class Plug(BaseAsana):
    def __init__(self, **kwargs):
        ...
        self.pool("start").append("name_plug1")
        self.pool("start").append("name_plug2")
        self.pool("start").append("name_plug3")
        self.pool("start").append("name_plug4")
        self.pool("start").append("name_plug5")
        self.pool("start").append("name_plug_i_u_nas")
        self.pool("start").append("name_plug_i_uhodim")
